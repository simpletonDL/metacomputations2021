...
'((read vs0_2)
  (0
   ...
   (code_2 := `(,state_2))
   (pp_2 := (car state_2))
   (if (equal? pp_2 (car '(initTM jumpTo_nextLbl loopCond))) 1 86))
  (1
   (reducedExprAss_2 := (reduceExpr (caddr '(Left := '())) vs_2))
   (cmdAssDynamic_2 := (list (car '(Left := '())) ':= reducedExprAss_2))
   (code_2 := (append code_2 `(,cmdAssDynamic_2)))
   (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr '(progTail := progTM))))
   (vs_2 := (changeSt vs_2 (car '(progTail := progTM)) valueAssignStatic_2))
   (if (evalWithEnv vs_2 (cadr '(if (equal? (length progTail) 0) exitTM loop))) 2 67))
  (2
   (redExpr_2 := (reduceExpr (cadr '(return `(,Left unquote Right))) vs_2))
   (code_2 := (append code_2 `((return ,redExpr_2))))
   (residual_2 := (append residual_2 `(,code_2)))
  ...
  (4
   ...
   (code_2 := `(,state_2))
   (pp_2 := (car state_2))
   (if (equal? pp_2 (car '(initTM jumpTo_nextLbl loopCond))) 5 6))
  (5
   (reducedExprAss_2 := (reduceExpr (caddr '(Left := '())) vs_2))
   (cmdAssDynamic_2 := (list (car '(Left := '())) ':= reducedExprAss_2))
   (code_2 := (append code_2 `(,cmdAssDynamic_2)))
   ...
   (vs_2 := (changeSt vs_2 (car '(progTail := progTM)) valueAssignStatic_2))
   (if (evalWithEnv vs_2 (cadr '(if (equal? (length progTail) 0) exitTM loop))) 2 67))
  (6 (if (equal? pp_2 (car '(jumpTo_nextLbl loopCond))) 7 64))
  (7
   (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr '(progTail := (member nextLbl progTM (lambda (lbl inst) (equal? lbl (car inst))))))))
   (vs_2 := (changeSt vs_2 (car '(progTail := (member nextLbl progTM (lambda (lbl inst) (equal? lbl (car inst)))))) valueAssignStatic_2))
   (if (evalWithEnv vs_2 (cadr '(if (equal? (length progTail) 0) exitTM loop))) 8 45))
  (8
   (redExpr_2 := (reduceExpr (cadr '(return `(,Left unquote Right))) vs_2))
   (code_2 := (append code_2 `((return ,redExpr_2))))
   (residual_2 := (append residual_2 `(,code_2)))
   (if (null? states_2) 9 10))
  (9 (return residual_2))
  (10
   (state_2 := (car states_2))
   (states_2 := (cdr states_2))
   ...
   (code_2 := `(,state_2))
   (pp_2 := (car state_2))
   (if (equal? pp_2 (car '(initTM jumpTo_nextLbl loopCond))) 11 12))
  (11
   (reducedExprAss_2 := (reduceExpr (caddr '(Left := '())) vs_2))
   (cmdAssDynamic_2 := (list (car '(Left := '())) ':= reducedExprAss_2))
   (code_2 := (append code_2 `(,cmdAssDynamic_2)))
   ...
   (vs_2 := (changeSt vs_2 (car '(progTail := progTM)) valueAssignStatic_2))
   (if (evalWithEnv vs_2 (cadr '(if (equal? (length progTail) 0) exitTM loop))) 2 67))
  (12 (if (equal? pp_2 (car '(jumpTo_nextLbl loopCond))) 13 14))
  (13
   (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr '(progTail := (member nextLbl progTM (lambda (lbl inst) (equal? lbl (car inst))))))))
   (vs_2 := (changeSt vs_2 (car '(progTail := (member nextLbl progTM (lambda (lbl inst) (equal? lbl (car inst)))))) valueAssignStatic_2))
   (if (evalWithEnv vs_2 (cadr '(if (equal? (length progTail) 0) exitTM loop))) 8 45))
  (14 (if (equal? pp_2 (car '(loopCond))) 15 44))
  (15 (if (evalWithEnv vs_2 (cadr '(if (equal? (length progTail) 0) exitTM loop))) 16 25))
  (16
   (redExpr_2 := (reduceExpr (cadr '(return `(,Left unquote Right))) vs_2))
   (code_2 := (append code_2 `((return ,redExpr_2))))
   (residual_2 := (append residual_2 `(,code_2)))
   (if (null? states_2) 17 18))
  ...
  (18
   ...
   (code_2 := `(,state_2))
   (pp_2 := (car state_2))
   (if (equal? pp_2 (car '(initTM jumpTo_nextLbl loopCond))) 19 20))
  (19
   (reducedExprAss_2 := (reduceExpr (caddr '(Left := '())) vs_2))
   (cmdAssDynamic_2 := (list (car '(Left := '())) ':= reducedExprAss_2))
   (code_2 := (append code_2 `(,cmdAssDynamic_2)))
   ...
   (vs_2 := (changeSt vs_2 (car '(progTail := progTM)) valueAssignStatic_2))
   (if (evalWithEnv vs_2 (cadr '(if (equal? (length progTail) 0) exitTM loop))) 2 67))
  (20 (if (equal? pp_2 (car '(jumpTo_nextLbl loopCond))) 21 22))
  (21
   (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr '(progTail := (member nextLbl progTM (lambda (lbl inst) (equal? lbl (car inst))))))))
   (vs_2 := (changeSt vs_2 (car '(progTail := (member nextLbl progTM (lambda (lbl inst) (equal? lbl (car inst)))))) valueAssignStatic_2))
   (if (evalWithEnv vs_2 (cadr '(if (equal? (length progTail) 0) exitTM loop))) 8 45))
  (22 (if (equal? pp_2 (car '(loopCond))) 23 24))
  (23 (if (evalWithEnv vs_2 (cadr '(if (equal? (length progTail) 0) exitTM loop))) 16 25))
  (24 (return residual_2))
  (25
   (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr '(inst := (cdr (car progTail))))))
   (vs_2 := (changeSt vs_2 (car '(inst := (cdr (car progTail)))) valueAssignStatic_2))
   (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr '(instHead := (car inst)))))
   (vs_2 := (changeSt vs_2 (car '(instHead := (car inst))) valueAssignStatic_2))
   (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr '(progTail := (cdr progTail)))))
   (vs_2 := (changeSt vs_2 (car '(progTail := (cdr progTail))) valueAssignStatic_2))
   (if (evalWithEnv vs_2 (cadr '(if (equal? instHead 'right) moveRight checkLeft))) 26 27))
  (26
   (reducedExprAss_2 := (reduceExpr (caddr '(Left := (cons (car Right) Left))) vs_2))
   (cmdAssDynamic_2 := (list (car '(Left := (cons (car Right) Left))) ':= reducedExprAss_2))
   (code_2 := (append code_2 `(,cmdAssDynamic_2)))
   (reducedExprAss_2 := (reduceExpr (caddr '(Right := (cdr Right))) vs_2))
   (cmdAssDynamic_2 := (list (car '(Right := (cdr Right))) ':= reducedExprAss_2))
   (code_2 := (append code_2 `(,cmdAssDynamic_2)))
   (if (evalWithEnv vs_2 (cadr '(if (equal? (length progTail) 0) exitTM loop))) 16 25))
  (27 (if (evalWithEnv vs_2 (cadr '(if (equal? instHead 'left) moveLeft checkGoto))) 28 29))
  (28
   (reducedExprAss_2 := (reduceExpr (caddr '(Right := (cons (car Left) Right))) vs_2))
   (cmdAssDynamic_2 := (list (car '(Right := (cons (car Left) Right))) ':= reducedExprAss_2))
   (code_2 := (append code_2 `(,cmdAssDynamic_2)))
   (reducedExprAss_2 := (reduceExpr (caddr '(Left := (cdr Left))) vs_2))
   (cmdAssDynamic_2 := (list (car '(Left := (cdr Left))) ':= reducedExprAss_2))
   (code_2 := (append code_2 `(,cmdAssDynamic_2)))
   (if (evalWithEnv vs_2 (cadr '(if (equal? (length progTail) 0) exitTM loop))) 16 25))
  (29 (if (evalWithEnv vs_2 (cadr '(if (equal? instHead 'goto) jump checkWrite))) 30 31))
  (30
   (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr '(nextLbl := (car (cdr inst))))))
   (vs_2 := (changeSt vs_2 (car '(nextLbl := (car (cdr inst)))) valueAssignStatic_2))
   (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr '(progTail := (member nextLbl progTM (lambda (lbl inst) (equal? lbl (car inst))))))))
   (vs_2 := (changeSt vs_2 (car '(progTail := (member nextLbl progTM (lambda (lbl inst) (equal? lbl (car inst)))))) valueAssignStatic_2))
   (if (evalWithEnv vs_2 (cadr '(if (equal? (length progTail) 0) exitTM loop))) 16 25))
  (31 (if (evalWithEnv vs_2 (cadr '(if (equal? instHead 'write) write checkIf))) 32 33))
  (32
   (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr '(value := (car (cdr inst))))))
   (vs_2 := (changeSt vs_2 (car '(value := (car (cdr inst)))) valueAssignStatic_2))
   (reducedExprAss_2 := (reduceExpr (caddr '(Right := (cons value (cdr Right)))) vs_2))
   (cmdAssDynamic_2 := (list (car '(Right := (cons value (cdr Right)))) ':= reducedExprAss_2))
   (code_2 := (append code_2 `(,cmdAssDynamic_2)))
   (if (evalWithEnv vs_2 (cadr '(if (equal? (length progTail) 0) exitTM loop))) 16 25))
  (33 (if (evalWithEnv vs_2 (cadr '(if (equal? instHead 'if) condJump exitTM))) 34 43))
  (34
   (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr '(condValue := (car (cdr inst))))))
   (vs_2 := (changeSt vs_2 (car '(condValue := (car (cdr inst)))) valueAssignStatic_2))
   (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr '(nextLbl := (car (cdr (cdr (cdr inst))))))))
   (vs_2 := (changeSt vs_2 (car '(nextLbl := (car (cdr (cdr (cdr inst)))))) valueAssignStatic_2))
   (true_state_2 := (cons (caddr '(if (equal? condValue (car Right)) jumpTo_nextLbl loopCond)) vs_2))
   (false_state_2 := (cons (cadddr '(if (equal? condValue (car Right)) jumpTo_nextLbl loopCond)) vs_2))
   ...
   (reducedExprIf_2 := (reduceExpr (cadr '(if (equal? condValue (car Right)) jumpTo_nextLbl loopCond)) vs_2))
  ...
  (36
   ...
   (code_2 := `(,state_2))
   (pp_2 := (car state_2))
   (if (equal? pp_2 (car '(initTM jumpTo_nextLbl loopCond))) 37 38))
  (37
   (reducedExprAss_2 := (reduceExpr (caddr '(Left := '())) vs_2))
   (cmdAssDynamic_2 := (list (car '(Left := '())) ':= reducedExprAss_2))
   (code_2 := (append code_2 `(,cmdAssDynamic_2)))
   ...
   (vs_2 := (changeSt vs_2 (car '(progTail := progTM)) valueAssignStatic_2))
   (if (evalWithEnv vs_2 (cadr '(if (equal? (length progTail) 0) exitTM loop))) 2 67))
  (38 (if (equal? pp_2 (car '(jumpTo_nextLbl loopCond))) 39 40))
  (39
   (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr '(progTail := (member nextLbl progTM (lambda (lbl inst) (equal? lbl (car inst))))))))
   (vs_2 := (changeSt vs_2 (car '(progTail := (member nextLbl progTM (lambda (lbl inst) (equal? lbl (car inst)))))) valueAssignStatic_2))
   (if (evalWithEnv vs_2 (cadr '(if (equal? (length progTail) 0) exitTM loop))) 8 45))
  (40 (if (equal? pp_2 (car '(loopCond))) 41 42))
  (41 (if (evalWithEnv vs_2 (cadr '(if (equal? (length progTail) 0) exitTM loop))) 16 25))
  ...
  (45
   ...
   (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr '(progTail := (cdr progTail)))))
   (vs_2 := (changeSt vs_2 (car '(progTail := (cdr progTail))) valueAssignStatic_2))
   (if (evalWithEnv vs_2 (cadr '(if (equal? instHead 'right) moveRight checkLeft))) 46 47))
  (46
   (reducedExprAss_2 := (reduceExpr (caddr '(Left := (cons (car Right) Left))) vs_2))
   (cmdAssDynamic_2 := (list (car '(Left := (cons (car Right) Left))) ':= reducedExprAss_2))
   (code_2 := (append code_2 `(,cmdAssDynamic_2)))
   ...
   (code_2 := (append code_2 `(,cmdAssDynamic_2)))
   (if (evalWithEnv vs_2 (cadr '(if (equal? (length progTail) 0) exitTM loop))) 8 45))
  (47 (if (evalWithEnv vs_2 (cadr '(if (equal? instHead 'left) moveLeft checkGoto))) 48 49))
  (48
   (reducedExprAss_2 := (reduceExpr (caddr '(Right := (cons (car Left) Right))) vs_2))
   (cmdAssDynamic_2 := (list (car '(Right := (cons (car Left) Right))) ':= reducedExprAss_2))
   (code_2 := (append code_2 `(,cmdAssDynamic_2)))
   ...
   (code_2 := (append code_2 `(,cmdAssDynamic_2)))
   (if (evalWithEnv vs_2 (cadr '(if (equal? (length progTail) 0) exitTM loop))) 8 45))
  (49 (if (evalWithEnv vs_2 (cadr '(if (equal? instHead 'goto) jump checkWrite))) 50 51))
  (50
   (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr '(nextLbl := (car (cdr inst))))))
   (vs_2 := (changeSt vs_2 (car '(nextLbl := (car (cdr inst)))) valueAssignStatic_2))
   (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr '(progTail := (member nextLbl progTM (lambda (lbl inst) (equal? lbl (car inst))))))))
   (vs_2 := (changeSt vs_2 (car '(progTail := (member nextLbl progTM (lambda (lbl inst) (equal? lbl (car inst)))))) valueAssignStatic_2))
   (if (evalWithEnv vs_2 (cadr '(if (equal? (length progTail) 0) exitTM loop))) 8 45))
  (51 (if (evalWithEnv vs_2 (cadr '(if (equal? instHead 'write) write checkIf))) 52 53))
  (52
   (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr '(value := (car (cdr inst))))))
   (vs_2 := (changeSt vs_2 (car '(value := (car (cdr inst)))) valueAssignStatic_2))
   (reducedExprAss_2 := (reduceExpr (caddr '(Right := (cons value (cdr Right)))) vs_2))
   ...
   (code_2 := (append code_2 `(,cmdAssDynamic_2)))
   (if (evalWithEnv vs_2 (cadr '(if (equal? (length progTail) 0) exitTM loop))) 8 45))
  (53 (if (evalWithEnv vs_2 (cadr '(if (equal? instHead 'if) condJump exitTM))) 54 63))
  (54
   (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr '(condValue := (car (cdr inst))))))
   (vs_2 := (changeSt vs_2 (car '(condValue := (car (cdr inst)))) valueAssignStatic_2))
   (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr '(nextLbl := (car (cdr (cdr (cdr inst))))))))
  ...
  (56
   ...
   (code_2 := `(,state_2))
   (pp_2 := (car state_2))
   (if (equal? pp_2 (car '(initTM jumpTo_nextLbl loopCond))) 57 58))
  (57
   (reducedExprAss_2 := (reduceExpr (caddr '(Left := '())) vs_2))
   (cmdAssDynamic_2 := (list (car '(Left := '())) ':= reducedExprAss_2))
   (code_2 := (append code_2 `(,cmdAssDynamic_2)))
   ...
   (vs_2 := (changeSt vs_2 (car '(progTail := progTM)) valueAssignStatic_2))
   (if (evalWithEnv vs_2 (cadr '(if (equal? (length progTail) 0) exitTM loop))) 2 67))
  (58 (if (equal? pp_2 (car '(jumpTo_nextLbl loopCond))) 59 60))
  (59
   (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr '(progTail := (member nextLbl progTM (lambda (lbl inst) (equal? lbl (car inst))))))))
   (vs_2 := (changeSt vs_2 (car '(progTail := (member nextLbl progTM (lambda (lbl inst) (equal? lbl (car inst)))))) valueAssignStatic_2))
   (if (evalWithEnv vs_2 (cadr '(if (equal? (length progTail) 0) exitTM loop))) 8 45))
  (60 (if (equal? pp_2 (car '(loopCond))) 61 62))
  (61 (if (evalWithEnv vs_2 (cadr '(if (equal? (length progTail) 0) exitTM loop))) 16 25))
  ...
  (63
   ...
   (residual_2 := (append residual_2 `(,code_2)))
   (if (null? states_2) 9 10))
  (64 (if (equal? pp_2 (car '(loopCond))) 65 66))
  (65 (if (evalWithEnv vs_2 (cadr '(if (equal? (length progTail) 0) exitTM loop))) 16 25))
  ...
  (67
   ...
   (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr '(progTail := (cdr progTail)))))
   (vs_2 := (changeSt vs_2 (car '(progTail := (cdr progTail))) valueAssignStatic_2))
   (if (evalWithEnv vs_2 (cadr '(if (equal? instHead 'right) moveRight checkLeft))) 68 69))
  (68
   (reducedExprAss_2 := (reduceExpr (caddr '(Left := (cons (car Right) Left))) vs_2))
   (cmdAssDynamic_2 := (list (car '(Left := (cons (car Right) Left))) ':= reducedExprAss_2))
   (code_2 := (append code_2 `(,cmdAssDynamic_2)))
   ...
   (code_2 := (append code_2 `(,cmdAssDynamic_2)))
   (if (evalWithEnv vs_2 (cadr '(if (equal? (length progTail) 0) exitTM loop))) 2 67))
  (69 (if (evalWithEnv vs_2 (cadr '(if (equal? instHead 'left) moveLeft checkGoto))) 70 71))
  (70
   (reducedExprAss_2 := (reduceExpr (caddr '(Right := (cons (car Left) Right))) vs_2))
   (cmdAssDynamic_2 := (list (car '(Right := (cons (car Left) Right))) ':= reducedExprAss_2))
   (code_2 := (append code_2 `(,cmdAssDynamic_2)))
   ...
   (code_2 := (append code_2 `(,cmdAssDynamic_2)))
   (if (evalWithEnv vs_2 (cadr '(if (equal? (length progTail) 0) exitTM loop))) 2 67))
  (71 (if (evalWithEnv vs_2 (cadr '(if (equal? instHead 'goto) jump checkWrite))) 72 73))
  (72
   (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr '(nextLbl := (car (cdr inst))))))
   (vs_2 := (changeSt vs_2 (car '(nextLbl := (car (cdr inst)))) valueAssignStatic_2))
   (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr '(progTail := (member nextLbl progTM (lambda (lbl inst) (equal? lbl (car inst))))))))
   (vs_2 := (changeSt vs_2 (car '(progTail := (member nextLbl progTM (lambda (lbl inst) (equal? lbl (car inst)))))) valueAssignStatic_2))
   (if (evalWithEnv vs_2 (cadr '(if (equal? (length progTail) 0) exitTM loop))) 2 67))
  (73 (if (evalWithEnv vs_2 (cadr '(if (equal? instHead 'write) write checkIf))) 74 75))
  (74
   (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr '(value := (car (cdr inst))))))
   (vs_2 := (changeSt vs_2 (car '(value := (car (cdr inst)))) valueAssignStatic_2))
   (reducedExprAss_2 := (reduceExpr (caddr '(Right := (cons value (cdr Right)))) vs_2))
   ...
   (code_2 := (append code_2 `(,cmdAssDynamic_2)))
   (if (evalWithEnv vs_2 (cadr '(if (equal? (length progTail) 0) exitTM loop))) 2 67))
  (75 (if (evalWithEnv vs_2 (cadr '(if (equal? instHead 'if) condJump exitTM))) 76 85))
  (76
   (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr '(condValue := (car (cdr inst))))))
   (vs_2 := (changeSt vs_2 (car '(condValue := (car (cdr inst)))) valueAssignStatic_2))
   (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr '(nextLbl := (car (cdr (cdr (cdr inst))))))))
  ...
  (78
   ...
   (code_2 := `(,state_2))
   (pp_2 := (car state_2))
   (if (equal? pp_2 (car '(initTM jumpTo_nextLbl loopCond))) 79 80))
  (79
   (reducedExprAss_2 := (reduceExpr (caddr '(Left := '())) vs_2))
   (cmdAssDynamic_2 := (list (car '(Left := '())) ':= reducedExprAss_2))
   (code_2 := (append code_2 `(,cmdAssDynamic_2)))
   ...
   (vs_2 := (changeSt vs_2 (car '(progTail := progTM)) valueAssignStatic_2))
   (if (evalWithEnv vs_2 (cadr '(if (equal? (length progTail) 0) exitTM loop))) 2 67))
  (80 (if (equal? pp_2 (car '(jumpTo_nextLbl loopCond))) 81 82))
  (81
   (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr '(progTail := (member nextLbl progTM (lambda (lbl inst) (equal? lbl (car inst))))))))
   (vs_2 := (changeSt vs_2 (car '(progTail := (member nextLbl progTM (lambda (lbl inst) (equal? lbl (car inst)))))) valueAssignStatic_2))
   (if (evalWithEnv vs_2 (cadr '(if (equal? (length progTail) 0) exitTM loop))) 8 45))
  (82 (if (equal? pp_2 (car '(loopCond))) 83 84))
  (83 (if (evalWithEnv vs_2 (cadr '(if (equal? (length progTail) 0) exitTM loop))) 16 25))
  ...
  (85
   ...
   (residual_2 := (append residual_2 `(,code_2)))
   (if (null? states_2) 3 4))
  (86 (if (equal? pp_2 (car '(jumpTo_nextLbl loopCond))) 87 88))
  (87
   (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr '(progTail := (member nextLbl progTM (lambda (lbl inst) (equal? lbl (car inst))))))))
   (vs_2 := (changeSt vs_2 (car '(progTail := (member nextLbl progTM (lambda (lbl inst) (equal? lbl (car inst)))))) valueAssignStatic_2))
   (if (evalWithEnv vs_2 (cadr '(if (equal? (length progTail) 0) exitTM loop))) 8 45))
  (88 (if (equal? pp_2 (car '(loopCond))) 89 90))
  (89 (if (evalWithEnv vs_2 (cadr '(if (equal? (length progTail) 0) exitTM loop))) 16 25))
