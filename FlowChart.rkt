...
'((0
   ...
   (pp_2 := (car state_2))
   (println curTrickLabels_2)
   (if (equal? pp_2 (car curTrickLabels_2)) 1 86))
  (1
   (reducedExprAss_2 := (reduceExpr (caddr cmd_2) vs_2))
   (cmdAssDynamic_2 := `(,(car cmd_2) := ,reducedExprAss_2))
   (code_2 := (append code_2 `(,cmdAssDynamic_2)))
   (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr cmd_2)))
   (vs_2 := (changeSt vs_2 (car cmd_2) valueAssignStatic_2))
   (if (evalWithEnv vs_2 (cadr cmd_2)) 2 67))
  (2 (redExpr_2 := (reduceExpr (cadr cmd_2) vs_2)) (code_2 := (append code_2 `((return ,redExpr_2)))) (residual_2 := (append residual_2 `(,code_2))) (if (null? states_2) 3 4))
  (3 (return residual_2))
  (4
   (state_2 := (car states_2))
   (states_2 := (cdr states_2))
   ...
   (pp_2 := (car state_2))
   (println curTrickLabels_2)
   (if (equal? pp_2 (car curTrickLabels_2)) 5 6))
  (5
   (reducedExprAss_2 := (reduceExpr (caddr cmd_2) vs_2))
   (cmdAssDynamic_2 := `(,(car cmd_2) := ,reducedExprAss_2))
   (code_2 := (append code_2 `(,cmdAssDynamic_2)))
   ...
   (vs_2 := (changeSt vs_2 (car cmd_2) valueAssignStatic_2))
   (if (evalWithEnv vs_2 (cadr cmd_2)) 2 67))
  (6 (println curTrickLabels_2) (if (equal? pp_2 (car curTrickLabels_2)) 7 64))
  (7 (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr cmd_2))) (vs_2 := (changeSt vs_2 (car cmd_2) valueAssignStatic_2)) (if (evalWithEnv vs_2 (cadr cmd_2)) 8 45))
  (8 (redExpr_2 := (reduceExpr (cadr cmd_2) vs_2)) (code_2 := (append code_2 `((return ,redExpr_2)))) (residual_2 := (append residual_2 `(,code_2))) (if (null? states_2) 9 10))
  (9 (return residual_2))
  (10
   (state_2 := (car states_2))
   (states_2 := (cdr states_2))
   ...
   (pp_2 := (car state_2))
   (println curTrickLabels_2)
   (if (equal? pp_2 (car curTrickLabels_2)) 11 12))
  (11
   (reducedExprAss_2 := (reduceExpr (caddr cmd_2) vs_2))
   (cmdAssDynamic_2 := `(,(car cmd_2) := ,reducedExprAss_2))
   (code_2 := (append code_2 `(,cmdAssDynamic_2)))
   ...
   (vs_2 := (changeSt vs_2 (car cmd_2) valueAssignStatic_2))
   (if (evalWithEnv vs_2 (cadr cmd_2)) 2 67))
  (12 (println curTrickLabels_2) (if (equal? pp_2 (car curTrickLabels_2)) 13 14))
  (13 (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr cmd_2))) (vs_2 := (changeSt vs_2 (car cmd_2) valueAssignStatic_2)) (if (evalWithEnv vs_2 (cadr cmd_2)) 8 45))
  (14 (println curTrickLabels_2) (if (equal? pp_2 (car curTrickLabels_2)) 15 44))
  (15 (if (evalWithEnv vs_2 (cadr cmd_2)) 16 25))
  (16 (redExpr_2 := (reduceExpr (cadr cmd_2) vs_2)) (code_2 := (append code_2 `((return ,redExpr_2)))) (residual_2 := (append residual_2 `(,code_2))) (if (null? states_2) 17 18))
  ...
  (18
   ...
   (pp_2 := (car state_2))
   (println curTrickLabels_2)
   (if (equal? pp_2 (car curTrickLabels_2)) 19 20))
  (19
   (reducedExprAss_2 := (reduceExpr (caddr cmd_2) vs_2))
   (cmdAssDynamic_2 := `(,(car cmd_2) := ,reducedExprAss_2))
   (code_2 := (append code_2 `(,cmdAssDynamic_2)))
   ...
   (vs_2 := (changeSt vs_2 (car cmd_2) valueAssignStatic_2))
   (if (evalWithEnv vs_2 (cadr cmd_2)) 2 67))
  (20 (println curTrickLabels_2) (if (equal? pp_2 (car curTrickLabels_2)) 21 22))
  (21 (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr cmd_2))) (vs_2 := (changeSt vs_2 (car cmd_2) valueAssignStatic_2)) (if (evalWithEnv vs_2 (cadr cmd_2)) 8 45))
  (22 (println curTrickLabels_2) (if (equal? pp_2 (car curTrickLabels_2)) 23 24))
  (23 (if (evalWithEnv vs_2 (cadr cmd_2)) 16 25))
  ...
  (25
   ...
   (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr cmd_2)))
   (vs_2 := (changeSt vs_2 (car cmd_2) valueAssignStatic_2))
   (if (evalWithEnv vs_2 (cadr cmd_2)) 26 27))
  (26
   (reducedExprAss_2 := (reduceExpr (caddr cmd_2) vs_2))
   (cmdAssDynamic_2 := `(,(car cmd_2) := ,reducedExprAss_2))
   (code_2 := (append code_2 `(,cmdAssDynamic_2)))
   ...
   (cmdAssDynamic_2 := `(,(car cmd_2) := ,reducedExprAss_2))
   (code_2 := (append code_2 `(,cmdAssDynamic_2)))
   (if (evalWithEnv vs_2 (cadr cmd_2)) 16 25))
  (27 (if (evalWithEnv vs_2 (cadr cmd_2)) 28 29))
  (28
   (reducedExprAss_2 := (reduceExpr (caddr cmd_2) vs_2))
   (cmdAssDynamic_2 := `(,(car cmd_2) := ,reducedExprAss_2))
   (code_2 := (append code_2 `(,cmdAssDynamic_2)))
   ...
   (code_2 := (append code_2 `(,cmdAssDynamic_2)))
   (if (evalWithEnv vs_2 (cadr cmd_2)) 16 25))
  (29 (if (evalWithEnv vs_2 (cadr cmd_2)) 30 31))
  (30
   (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr cmd_2)))
   (vs_2 := (changeSt vs_2 (car cmd_2) valueAssignStatic_2))
   (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr cmd_2)))
   (vs_2 := (changeSt vs_2 (car cmd_2) valueAssignStatic_2))
   (if (evalWithEnv vs_2 (cadr cmd_2)) 16 25))
  (31 (if (evalWithEnv vs_2 (cadr cmd_2)) 32 33))
  (32
   (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr cmd_2)))
   (vs_2 := (changeSt vs_2 (car cmd_2) valueAssignStatic_2))
   (reducedExprAss_2 := (reduceExpr (caddr cmd_2) vs_2))
   ...
   (code_2 := (append code_2 `(,cmdAssDynamic_2)))
   (if (evalWithEnv vs_2 (cadr cmd_2)) 16 25))
  (33 (if (evalWithEnv vs_2 (cadr cmd_2)) 34 43))
  (34
   (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr cmd_2)))
   (vs_2 := (changeSt vs_2 (car cmd_2) valueAssignStatic_2))
   (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr cmd_2)))
   (vs_2 := (changeSt vs_2 (car cmd_2) valueAssignStatic_2))
   (true_state_2 := `(,(caddr cmd_2) unquote vs_2))
   (false_state_2 := `(,(cadddr cmd_2) unquote vs_2))
   ...
   (reducedExprIf_2 := (reduceExpr (cadr cmd_2) vs_2))
   (code_2 := (append code_2 `((if ,reducedExprIf_2 ,true_state_2 ,false_state_2))))
  ...
  (36
   ...
   (pp_2 := (car state_2))
   (println curTrickLabels_2)
   (if (equal? pp_2 (car curTrickLabels_2)) 37 38))
  (37
   (reducedExprAss_2 := (reduceExpr (caddr cmd_2) vs_2))
   (cmdAssDynamic_2 := `(,(car cmd_2) := ,reducedExprAss_2))
   (code_2 := (append code_2 `(,cmdAssDynamic_2)))
   ...
   (vs_2 := (changeSt vs_2 (car cmd_2) valueAssignStatic_2))
   (if (evalWithEnv vs_2 (cadr cmd_2)) 2 67))
  (38 (println curTrickLabels_2) (if (equal? pp_2 (car curTrickLabels_2)) 39 40))
  (39 (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr cmd_2))) (vs_2 := (changeSt vs_2 (car cmd_2) valueAssignStatic_2)) (if (evalWithEnv vs_2 (cadr cmd_2)) 8 45))
  (40 (println curTrickLabels_2) (if (equal? pp_2 (car curTrickLabels_2)) 41 42))
  (41 (if (evalWithEnv vs_2 (cadr cmd_2)) 16 25))
  (42 (return residual_2))
  (43 (redExpr_2 := (reduceExpr (cadr cmd_2) vs_2)) (code_2 := (append code_2 `((return ,redExpr_2)))) (residual_2 := (append residual_2 `(,code_2))) (if (null? states_2) 17 18))
  ...
  (45
   ...
   (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr cmd_2)))
   (vs_2 := (changeSt vs_2 (car cmd_2) valueAssignStatic_2))
   (if (evalWithEnv vs_2 (cadr cmd_2)) 46 47))
  (46
   (reducedExprAss_2 := (reduceExpr (caddr cmd_2) vs_2))
   (cmdAssDynamic_2 := `(,(car cmd_2) := ,reducedExprAss_2))
   (code_2 := (append code_2 `(,cmdAssDynamic_2)))
   ...
   (cmdAssDynamic_2 := `(,(car cmd_2) := ,reducedExprAss_2))
   (code_2 := (append code_2 `(,cmdAssDynamic_2)))
   (if (evalWithEnv vs_2 (cadr cmd_2)) 8 45))
  (47 (if (evalWithEnv vs_2 (cadr cmd_2)) 48 49))
  (48
   (reducedExprAss_2 := (reduceExpr (caddr cmd_2) vs_2))
   (cmdAssDynamic_2 := `(,(car cmd_2) := ,reducedExprAss_2))
   (code_2 := (append code_2 `(,cmdAssDynamic_2)))
   ...
   (code_2 := (append code_2 `(,cmdAssDynamic_2)))
   (if (evalWithEnv vs_2 (cadr cmd_2)) 8 45))
  (49 (if (evalWithEnv vs_2 (cadr cmd_2)) 50 51))
  (50
   (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr cmd_2)))
   (vs_2 := (changeSt vs_2 (car cmd_2) valueAssignStatic_2))
   (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr cmd_2)))
   (vs_2 := (changeSt vs_2 (car cmd_2) valueAssignStatic_2))
   (if (evalWithEnv vs_2 (cadr cmd_2)) 8 45))
  (51 (if (evalWithEnv vs_2 (cadr cmd_2)) 52 53))
  (52
   (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr cmd_2)))
   (vs_2 := (changeSt vs_2 (car cmd_2) valueAssignStatic_2))
   (reducedExprAss_2 := (reduceExpr (caddr cmd_2) vs_2))
   ...
   (code_2 := (append code_2 `(,cmdAssDynamic_2)))
   (if (evalWithEnv vs_2 (cadr cmd_2)) 8 45))
  (53 (if (evalWithEnv vs_2 (cadr cmd_2)) 54 63))
  (54
   (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr cmd_2)))
   (vs_2 := (changeSt vs_2 (car cmd_2) valueAssignStatic_2))
   (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr cmd_2)))
  ...
  (56
   ...
   (pp_2 := (car state_2))
   (println curTrickLabels_2)
   (if (equal? pp_2 (car curTrickLabels_2)) 57 58))
  (57
   (reducedExprAss_2 := (reduceExpr (caddr cmd_2) vs_2))
   (cmdAssDynamic_2 := `(,(car cmd_2) := ,reducedExprAss_2))
   (code_2 := (append code_2 `(,cmdAssDynamic_2)))
   ...
   (vs_2 := (changeSt vs_2 (car cmd_2) valueAssignStatic_2))
   (if (evalWithEnv vs_2 (cadr cmd_2)) 2 67))
  (58 (println curTrickLabels_2) (if (equal? pp_2 (car curTrickLabels_2)) 59 60))
  (59 (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr cmd_2))) (vs_2 := (changeSt vs_2 (car cmd_2) valueAssignStatic_2)) (if (evalWithEnv vs_2 (cadr cmd_2)) 8 45))
  (60 (println curTrickLabels_2) (if (equal? pp_2 (car curTrickLabels_2)) 61 62))
  (61 (if (evalWithEnv vs_2 (cadr cmd_2)) 16 25))
  (62 (return residual_2))
  (63 (redExpr_2 := (reduceExpr (cadr cmd_2) vs_2)) (code_2 := (append code_2 `((return ,redExpr_2)))) (residual_2 := (append residual_2 `(,code_2))) (if (null? states_2) 9 10))
  (64 (println curTrickLabels_2) (if (equal? pp_2 (car curTrickLabels_2)) 65 66))
  (65 (if (evalWithEnv vs_2 (cadr cmd_2)) 16 25))
  ...
  (67
   ...
   (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr cmd_2)))
   (vs_2 := (changeSt vs_2 (car cmd_2) valueAssignStatic_2))
   (if (evalWithEnv vs_2 (cadr cmd_2)) 68 69))
  (68
   (reducedExprAss_2 := (reduceExpr (caddr cmd_2) vs_2))
   (cmdAssDynamic_2 := `(,(car cmd_2) := ,reducedExprAss_2))
   (code_2 := (append code_2 `(,cmdAssDynamic_2)))
   ...
   (code_2 := (append code_2 `(,cmdAssDynamic_2)))
   (if (evalWithEnv vs_2 (cadr cmd_2)) 2 67))
  (69 (if (evalWithEnv vs_2 (cadr cmd_2)) 70 71))
  (70
   (reducedExprAss_2 := (reduceExpr (caddr cmd_2) vs_2))
   (cmdAssDynamic_2 := `(,(car cmd_2) := ,reducedExprAss_2))
   (code_2 := (append code_2 `(,cmdAssDynamic_2)))
   ...
   (code_2 := (append code_2 `(,cmdAssDynamic_2)))
   (if (evalWithEnv vs_2 (cadr cmd_2)) 2 67))
  (71 (if (evalWithEnv vs_2 (cadr cmd_2)) 72 73))
  (72
   (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr cmd_2)))
   (vs_2 := (changeSt vs_2 (car cmd_2) valueAssignStatic_2))
   (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr cmd_2)))
   (vs_2 := (changeSt vs_2 (car cmd_2) valueAssignStatic_2))
   (if (evalWithEnv vs_2 (cadr cmd_2)) 2 67))
  (73 (if (evalWithEnv vs_2 (cadr cmd_2)) 74 75))
  (74
   (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr cmd_2)))
   (vs_2 := (changeSt vs_2 (car cmd_2) valueAssignStatic_2))
   (reducedExprAss_2 := (reduceExpr (caddr cmd_2) vs_2))
   ...
   (code_2 := (append code_2 `(,cmdAssDynamic_2)))
   (if (evalWithEnv vs_2 (cadr cmd_2)) 2 67))
  (75 (if (evalWithEnv vs_2 (cadr cmd_2)) 76 85))
  (76
   (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr cmd_2)))
   (vs_2 := (changeSt vs_2 (car cmd_2) valueAssignStatic_2))
   (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr cmd_2)))
  ...
  (78
   ...
   (pp_2 := (car state_2))
   (println curTrickLabels_2)
   (if (equal? pp_2 (car curTrickLabels_2)) 79 80))
  (79
   (reducedExprAss_2 := (reduceExpr (caddr cmd_2) vs_2))
   (cmdAssDynamic_2 := `(,(car cmd_2) := ,reducedExprAss_2))
   (code_2 := (append code_2 `(,cmdAssDynamic_2)))
   ...
   (vs_2 := (changeSt vs_2 (car cmd_2) valueAssignStatic_2))
   (if (evalWithEnv vs_2 (cadr cmd_2)) 2 67))
  (80 (println curTrickLabels_2) (if (equal? pp_2 (car curTrickLabels_2)) 81 82))
  (81 (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr cmd_2))) (vs_2 := (changeSt vs_2 (car cmd_2) valueAssignStatic_2)) (if (evalWithEnv vs_2 (cadr cmd_2)) 8 45))
  (82 (println curTrickLabels_2) (if (equal? pp_2 (car curTrickLabels_2)) 83 84))
  (83 (if (evalWithEnv vs_2 (cadr cmd_2)) 16 25))
  (84 (return residual_2))
  (85 (redExpr_2 := (reduceExpr (cadr cmd_2) vs_2)) (code_2 := (append code_2 `((return ,redExpr_2)))) (residual_2 := (append residual_2 `(,code_2))) (if (null? states_2) 3 4))
  (86 (println curTrickLabels_2) (if (equal? pp_2 (car curTrickLabels_2)) 87 88))
  (87 (valueAssignStatic_2 := (evalWithEnv vs_2 (caddr cmd_2))) (vs_2 := (changeSt vs_2 (car cmd_2) valueAssignStatic_2)) (if (evalWithEnv vs_2 (cadr cmd_2)) 8 45))
  (88 (println curTrickLabels_2) (if (equal? pp_2 (car curTrickLabels_2)) 89 90))
  (89 (if (evalWithEnv vs_2 (cadr cmd_2)) 16 25))
